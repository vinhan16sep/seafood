                            ...
                            <table id="table" class="table table_product">
                                ...
                                <?php foreach ($blogs as $key => $value): ?>
                                    ...
                                    <tr class="remove_<?php echo $value['id'] ?>">
                                        ...
                                        <td>
                                            <div class="mask_sm">
                                                <img src="<?php echo base_url('assets/upload/blog/'. $value['image']) ?>" alt="anh-cua-<?php echo $value['slug'] ?>">
                                            </div>
                                        </td>
                                        ...
                                        <td>
                                            ...
                                            <a href="javascript:void(0);" onclick="remove('blog', <?php echo $value['id'] ?>)" class="dataActionDelete"><i class="fa fa-remove" aria-hidden="true"></i> </a>
                                        </td>
