                            ...
                            <div class="tab-content">
                                <div role="tabpanel" class="tab-pane active" id="vi">
                                    ...
                                    <div class="form-group col-xs-12">
                                        ...
                                        echo form_textarea('content_vi', set_value('content_vi', '', false), 'class="tinymce-area" class="form-control"')
                                        ?>
                                    </div>
                                </div>
                                <div role="tabpanel" class="tab-pane" id="en">
                                    ...
                                    <div class="form-group col-xs-12">
                                        ...
                                        echo form_textarea('content_en', set_value('content_en', '', false), 'class="tinymce-area" class="form-control"')
                                        ?>
                                    </div>
                                </div>
                                <div role="tabpanel" class="tab-pane" id="cn">
                                    ...
                                    <div class="form-group col-xs-12">
                                        ...
                                        echo form_textarea('content_cn', set_value('content_cn', '', false), 'class="tinymce-area" class="form-control"')
                                        ?>
                                    </div>
                                </div>
                            </div>
